...
static rvl_tap_state_t rvl_tap_trace_state(int tms)
{
    switch (rvl_tap_current_state) {
        case RVL_TAP_STATE_TEST_LOGIC_RESET:
            if (!tms) { 
                rvl_tap_current_state = RVL_TAP_STATE_RUN_TEST_IDLE;
            }
            break;
        case RVL_TAP_STATE_RUN_TEST_IDLE:
            if (tms) {
                rvl_tap_current_state = RVL_TAP_STATE_SELECT_DR_SCAN;
            }
            break;
        case RVL_TAP_STATE_SELECT_DR_SCAN:
            if (tms) {
                ...
                rvl_tap_current_state = RVL_TAP_STATE_CAPTURE_DR;
            }
            break;
        case RVL_TAP_STATE_SELECT_IR_SCAN:
            if (tms) {
                ...
                rvl_tap_current_state = RVL_TAP_STATE_CAPTURE_IR;
            }
            break;
        case RVL_TAP_STATE_CAPTURE_DR:
            if (tms) {
                rvl_tap_current_state = RVL_TAP_STATE_EXIT1_DR;
            } else {
                rvl_tap_current_state = RVL_TAP_STATE_SHIFT_DR;
            }
            break;
        ...
        case RVL_TAP_STATE_EXIT1_DR:
            if (tms) {
                rvl_tap_current_state = RVL_TAP_STATE_UPDATE_DR;
            } else {
                rvl_tap_current_state = RVL_TAP_STATE_PAUSE_DR;
            }
            break;
        case RVL_TAP_STATE_PAUSE_DR:
            if (tms) {
                rvl_tap_current_state = RVL_TAP_STATE_EXIT2_DR;
            }
            break;
        ...
        case RVL_TAP_STATE_CAPTURE_IR:
            if (tms) {
                rvl_tap_current_state = RVL_TAP_STATE_EXIT1_IR;
            } else {
                rvl_tap_current_state = RVL_TAP_STATE_SHIFT_IR;
            }
            break;
        ...
        case RVL_TAP_STATE_EXIT1_IR:
            if (tms) {
                rvl_tap_current_state = RVL_TAP_STATE_UPDATE_IR;
            } else {
                rvl_tap_current_state = RVL_TAP_STATE_PAUSE_IR;
            }
            break;
        case RVL_TAP_STATE_PAUSE_IR:
            if (tms) {
                rvl_tap_current_state = RVL_TAP_STATE_EXIT2_IR;
            }
            break;
