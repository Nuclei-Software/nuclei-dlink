...
static const char target_xml_str[] =
{
...
#if (RVL_TARGET_CONFIG_RISCV_FLEN == 4)
    ...
    "</feature>"
#elif (RVL_TARGET_CONFIG_RISCV_FLEN == 8)
    "<feature name=\"org.gnu.gdb.riscv.fpu\">"
...
#ifdef RVL_TARGET_CONFIG_RISCV_FEATURE_CSR
...
#ifdef RVL_TARGET_CONFIG_RISCV_FEATURE_CSR_HPM
...
#endif // RVL_TARGET_CONFIG_RISCV_FEATURE_CSR_HPM
...
#ifdef RVL_TARGET_CONFIG_RISCV_FEATURE_CSR_PMP
    ...
    #endif // RVL_TARGET_CONFIG_RISCV_FEATURE_CSR_PMP

#ifdef RVL_TARGET_CONFIG_RISCV_FEATURE_CSR_DMODE
...
#endif // RVL_TARGET_CONFIG_RISCV_FEATURE_CSR_DMODE
...
#ifdef RVL_TARGET_CONFIG_RISCV_FEATURE_CSR_UMODE
...
#endif // RVL_TARGET_CONFIG_RISCV_FEATURE_CSR_HPM
#endif // RVL_TARGET_CONFIG_RISCV_FEATURE_CSR_UMODE
...
#ifdef RVL_TARGET_CONFIG_RISCV_FEATURE_VIRTUAL
    "<feature name=\"org.gnu.gdb.riscv.virtual\">"
    "<reg name=\"priv\" bitsize=\"8\" regnum=\"4161\" save-restore=\"no\" type=\"int\" group=\"general\"/>"
    "</feature>"
#endif // RVL_TARGET_CONFIG_RISCV_FEATURE_VIRTUAL
